...
def test_registrar_factura_exito(api_client: APIClient):
    ...
    pedido = PedidoMaterial.objects.create(of_id=orden, emisor="Ing", fecha="2026", estado="generado")
...
def test_registrar_factura_falla_si_ya_facturado(api_client: APIClient):
    orden = OrdenFabricacionFactory(estado="aprobada")
    pedido = PedidoMaterial.objects.create(of_id=orden, emisor="Ing", fecha="2026", estado="facturado")
